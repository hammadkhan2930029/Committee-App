...
const validationSchema = Yup.object().shape({
    ...
    message: Yup.string()
        .min(10, 'Message thora detail me likho')
...
export const SupportTeam = () => {
    ...
    const sendSupportMsg = async (value) => {
        ...
        try {
            ...
            const res = await api.post(`/user/send/feedback/support`, formData, {
            ...
            if (res?.data?.code === "200") {
                Toast.show({
                    type: 'customToast',
                    text1: 'Success',
                    text2: result || 'support msg send successfully',
                    props: {
                    ...
                    <View style={styles.headerContent}>
                        <View style={styles.headingAndArrow}>
                            ...
                            <View style={styles.hView}>
                                ...
                                <Icon name="contact-support" size={24} color="#fff" style={{ paddingHorizontal: 8 }} />
                            </View>
                        </View>
                        <View>
                            <Text style={styles.subHeading}>We're here to help you with any issues</Text>
                        </View>
                    </View>
                </ImageBackground>
