    ...
    return (
        <View style={styles.container}>
            ...
            <ScrollView style={styles.scrollView}>
                ...
                {/* ------------------------------------------------------------ */}
                <View style={styles.committeeForm}>
                    <Formik
                        initialValues={{
                            committeeName: '',
                            noOfMonths: '',
                    ...
                    >
                        {({
                            ...
                            useEffect(() => {
                                ...
                                //-------------------------------------
                                if (values.noOfMonths) {


                                    setFieldValue('totalMembers', values.noOfMonths);
                                    setFieldValue('totalRounds', values.noOfMonths);

                                }

                            }, [values.totalRounds, values.amountPerMember, values.noOfMonths]);
