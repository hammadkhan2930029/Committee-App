...
export const OtpVerification = () => {
    ...
    const { email, type, phone, userData } = route.params;
    ...
    const verifyOTP = async (value) => {
        ...
        try {
            ...
            const response = await api.post('/user/otp-verification', formData, {
    ...
    const resendOtpCode = async value => {
        ...
        <View style={styles.OTPContainer}>
            ...
            <View style={styles.main}>
                ...
                <View style={styles.reciveCode}>
                    ...
                    <TouchableOpacity
                        style={isResendActive ? styles.resendBtn : null}
                        disabled={!isResendActive}
                        onPress={resend_otp} >
                        <Text style={[styles.timer, { color: isResendActive && "#fff" }]}>
                            {isResendActive
