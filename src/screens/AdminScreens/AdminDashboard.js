        ...
        <View style={styles.Dashboardcard_View}>
            ...
            <View style={styles.Dashboardcard}>
              <View>
                <View style={styles.imgText}>
                  <Image source={AppIcons.Group} style={styles.group} />
          ...
          <TouchableOpacity activeOpacity={0.7}>
            <View style={styles.Dashboardcard}>
              <View>
                <View style={styles.imgText}>
                  <Image source={AppIcons.People} style={styles.group} />
          ...
          <TouchableOpacity activeOpacity={0.7}>
            <View style={styles.Dashboardcard}>
              <View>
                <View style={styles.imgText}>
                  <Image source={AppIcons.cardWallet} style={styles.group} />
